...
if ( !RST_n ) begin
	...
	if ( subband_state == ST_MIBUF ) begin
		...
		if ( fdct32_clk_cnt == 8'd0 ) begin
			...
			MI_BUF[15] <= ( mult0_out >>> 31 );
			MI_BUF[14] <= ( mult1_out >>> 31 );
			MI_BUF[13] <= ( mult2_out >>> 31 );
			MI_BUF[12] <= ( mult3_out >>> 31 );
			MI_BUF[11] <= ( mult4_out >>> 31 );
			MI_BUF[10] <= ( mult5_out >>> 30 );
			MI_BUF[ 9] <= ( mult6_out >>> 30 );
			MI_BUF[ 8] <= ( mult7_out >>> 28 ); 
			MI_BUF[31] <= ( mult8_out >>> 31 ); 
			MI_BUF[30] <= ( mult9_out >>> 31 ); 
			MI_BUF[29] <= ( mult10_out >>> 31 ); 
			MI_BUF[28] <= ( mult11_out >>> 31 ); 
			MI_BUF[27] <= ( mult12_out >>> 31 ); 
			MI_BUF[26] <= ( mult13_out >>> 30 ); 
			MI_BUF[25] <= ( mult14_out >>> 30 ); 
			MI_BUF[24] <= ( mult15_out >>> 28 ); 
