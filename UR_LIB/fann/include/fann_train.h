...
/* Function: fann_get_learning_momentum
   ...
   This function appears in FANN >= 2.0.0.   	
 */ 
float fann_get_learning_momentum(struct fann *ann);
...
/* Function: fann_set_learning_momentum
   ...
   This function appears in FANN >= 2.0.0.   	
 */ 
void fann_set_learning_momentum(struct fann *ann, float learning_momentum);
...
/* Function: fann_get_train_error_function
   ...
   This function appears in FANN >= 1.2.0.
  */ 
enum fann_errorfunc_enum fann_get_train_error_function(struct fann *ann);
...
/* Function: fann_get_train_stop_function
   ...
   This function appears in FANN >= 2.0.0.
 */ 
enum fann_stopfunc_enum fann_get_train_stop_function(struct fann *ann);
...
/* Function: fann_set_train_stop_function
   ...
   This function appears in FANN >= 2.0.0.
 */ 
void fann_set_train_stop_function(struct fann *ann,
...
/* Function: fann_get_bit_fail_limit
   ...
   This function appears in FANN >= 2.0.0.
 */ 
fann_type fann_get_bit_fail_limit(struct fann *ann);
...
/* Function: fann_set_bit_fail_limit
   ...
   This function appears in FANN >= 2.0.0.
 */ 
void fann_set_bit_fail_limit(struct fann *ann, fann_type bit_fail_limit);
...
/* Function: fann_set_rprop_increase_factor
   ...
   This function appears in FANN >= 1.2.0.
*/ 
void fann_set_rprop_increase_factor(struct fann *ann,
...
/* Function: fann_set_rprop_decrease_factor
   ...
   This function appears in FANN >= 1.2.0.
*/
void fann_set_rprop_decrease_factor(struct fann *ann,
...
/* Function: fann_get_rprop_delta_zero
   ...
   This function appears in FANN >= 2.1.0.
*/ 
float fann_get_rprop_delta_zero(struct fann *ann);
...
/* Function: fann_set_rprop_delta_zero
   ...
   This function appears in FANN >= 2.1.0.
*/
void fann_set_rprop_delta_zero(struct fann *ann, float rprop_delta_max);
...
/* Method: fann_get_sarprop_weight_decay_shift
   ...
   This function appears in FANN >= 2.1.0.
   */ 
float fann_get_sarprop_weight_decay_shift(struct fann *ann);
...
/* Method: fann_set_sarprop_weight_decay_shift
   ...
   */ 
void fann_set_sarprop_weight_decay_shift(struct fann *ann, float sarprop_weight_decay_shift);
...
/* Method: fann_get_sarprop_step_error_threshold_factor
   ...
   This function appears in FANN >= 2.1.0.
   */ 
float fann_get_sarprop_step_error_threshold_factor(struct fann *ann);
...
/* Method: fann_set_sarprop_step_error_threshold_factor
   ...
   */ 
void fann_set_sarprop_step_error_threshold_factor(struct fann *ann, float sarprop_step_error_threshold_factor);
...
/* Method: fann_get_sarprop_step_error_shift
   ...
   This function appears in FANN >= 2.1.0.
   */ 
float fann_get_sarprop_step_error_shift(struct fann *ann);
...
/* Method: fann_set_sarprop_step_error_shift
   ...
   */ 
void fann_set_sarprop_step_error_shift(struct fann *ann, float sarprop_step_error_shift);
...
/* Method: fann_get_sarprop_temperature
   ...
   This function appears in FANN >= 2.1.0.
   */ 
float fann_get_sarprop_temperature(struct fann *ann);
...
/* Method: fann_set_sarprop_temperature
   ...
   */ 
void fann_set_sarprop_temperature(struct fann *ann, float sarprop_temperature);
