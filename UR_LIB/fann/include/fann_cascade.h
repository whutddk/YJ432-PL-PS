...
/* Function: fann_get_cascade_output_change_fraction
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
float fann_get_cascade_output_change_fraction(struct fann *ann);
...
/* Function: fann_set_cascade_output_change_fraction
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
void fann_set_cascade_output_change_fraction(struct fann *ann, 
...
/* Function: fann_get_cascade_candidate_change_fraction
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
float fann_get_cascade_candidate_change_fraction(struct fann *ann);
...
/* Function: fann_set_cascade_candidate_change_fraction
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
void fann_set_cascade_candidate_change_fraction(struct fann *ann, 
...
/* Function: fann_get_cascade_weight_multiplier
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
fann_type fann_get_cascade_weight_multiplier(struct fann *ann);
...
/* Function: fann_set_cascade_weight_multiplier
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
void fann_set_cascade_weight_multiplier(struct fann *ann, 
...
/* Function: fann_get_cascade_candidate_limit
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
fann_type fann_get_cascade_candidate_limit(struct fann *ann);
...
/* Function: fann_set_cascade_candidate_limit
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
void fann_set_cascade_candidate_limit(struct fann *ann, 
...
/* Function: fann_get_cascade_activation_functions
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
enum fann_activationfunc_enum * fann_get_cascade_activation_functions(
															struct fann *ann);
...
/* Function: fann_get_cascade_activation_steepnesses
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
fann_type * fann_get_cascade_activation_steepnesses(struct fann *ann);
